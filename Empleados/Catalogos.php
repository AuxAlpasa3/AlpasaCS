            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header text-white" style="padding: 1rem; border-bottom: 2px solid #d94f00; background-color: #d94f00">
                        <h1 class="card-title">CATÁLOGO DE PERSONAL</h1>
                    </div>
                ...
                <!-- Modal para mostrar foto en tamaño completo -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function initEvents() {
                $('.thumbnail-image, .view-photo-link').off('click').on('click', function(e) {
                    ...
                    if (fullImage) {
                        ...
                        $('#downloadPhotoLink').attr('href', fullImage);
            ...
            $(document).on('click', '.btn-eliminar', function() {
                var id = $(this).data('id');
                loadModal('Modales/Eliminar.php?IdPersonal=' + id, '#EliminarPersonal', 'eliminar');
            });
            ...
            $(document).on('submit', '#formNuevoPersonal, #formModificarPersonal, #formCambiarEstatusPersonal, #formEliminarPersonal', function(e) {
                e.preventDefault();
                var form = $(this);
