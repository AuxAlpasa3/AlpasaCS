...
try {
    ...
    $html .= '
            ...
            <div class="text-overlay"><h4 class="remision">' .htmlspecialchars($IdRemisionOriginal). '</h4></div>
    ...
    <tr>
        ...
        <td width="auto">' . htmlspecialchars($item->Booking) . '</td>
                ...
                <div style="width: 100%; margin-top: 50px;">
                    ...
                    <div style="float: left; width: 33%; text-align: center;">
                        ...
                        <div class="signature-line">
                            ...
                            NOMBRE Y FIRMA DE EJECUTIVO DE CUENTA
                        </div>
                    </div>
                    <div style="float: left; width: 33%; text-align: center;">
    ...
    header('Content-Disposition: attachment; filename="Tarja_ALP' . $NumRecinto . '-ING-' . sprintf("%04d", $Tarja).'.pdf"');
    ...
    error_log("Database error in PDF generation: " . $e->getMessage());
    die("Error de base de datos: " . $e->getMessage());
} catch (Exception $e) {
    while (ob_get_level()) {
        ob_end_clean();
    }
    error_log("General error in PDF generation: " . $e->getMessage());
