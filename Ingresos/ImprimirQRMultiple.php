          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header text-white" style="padding: 1rem; border-bottom: 2px solid #d94f00; background-color: #d94f00 ">
                <h3>IMPRIMIR MULTIPLE POR CODIGO DE BARRAS</h3>
              </div>
              <div class="card-body">
                <form name="Imprimir" id="Imprimir" action="GenerarDocQRs.php" method="POST" enctype="multipart/form-data">
                  <div class="row" style="align-content: center;">
                    ...
                    <!-- SELECT CODIGOS -->
                    <div class="col-md-3" style="text-align: center;">
                      <label for="CodBarras">Seleccionar CodBarras</label>
                      <div class="form-group">
                        <select class="form-control select2" name="CodBarras[]" id="CodBarras" multiple="multiple"></select>
                      </div>
                    </div>
...
$(document).ready(function() {
  $('.select2').select2({
    placeholder: "Seleccione uno o más CodBarras...",
    allowClear: true,
    width: '100%',
    closeOnSelect: false 
  });
  ...
  $('#IdAlmacen').on('change', function() {
    ...
    if(almacenId){
      $.ajax({
        url: 'ajax_getCodBarras.php',
        type: 'POST',
        data: {IdAlmacen: almacenId},
        success: function(data){
          $('#CodBarras').html(data).trigger('change');
        }
      });
