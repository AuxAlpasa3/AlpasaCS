<?php
    ...
    function obtenerColorPorEstado($idEstado) {
        $colores = [
            1 => '#28a745', 2 => '#dc3545', 3 => '#fd7e14', 4 => '#ffc107', 5 => '#17a2b8', 6 => '#6f42c1',
            7 => '#e83e8c', 8 => '#20c997', 9 => '#6610f2', 10 => '#d63384', 11 => '#6c757d', 12 => '#0dcaf0',
            13 => '#ff6b6b', 14 => '#4ecdc4', 15 => '#ff9f43', 16 => '#a55eea', 17 => '#45aaf2', 18 => '#fc5c65',
            19 => '#fd9644', 20 => '#786fa6', 
        ];
        ...
        try {
            ...
            btnAceptar.onclick = () => {
                ...
                const campos = [
                    ...
                    { name: 'Ventana', value: 'IngresosFinalizados.php' }
                ];
