...
SELECT t2.IdTarja, t2.Transportista, t2.Placas, t2.Chofer, t2.IdRemision as IdRemisionEncabezado, t3.IdCliente, t3.NombreCliente, t5.IdAlmacen, t5.Almacen, t5.NumRecinto, t7.IdRemision, t1.IdUsuario as IdUsuarioAsignado
FROM t_salida t2
...
WHERE t2.Estatus IN (0,1,2) 
    AND t6.IdAlmacen = $IdAlmacen
    AND (t1.IdRemision IS NULL OR t1.IdUsuario = $IdUsuario)  
GROUP BY 
