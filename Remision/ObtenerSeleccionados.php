...
$sql = "SELECT t1.CodBarras,t3.NombreCliente,t1.MaterialNo,CONCAT(t4.Material,' ',t4.Shape) as Articulo, t7.NumRecinto,
  ...
  where  t2.IdRemisionAgrupada=? and t2.IdRemisionEncabezado=? and IdAlmacen=? and IdCliente=? and t8.Piezas>0 order by t1.CodBarras";

$stmt = $Conexion->prepare($sql);
$stmt->execute([$IdRemisionAgrupada, $IdRemisionEncabezado, $IdAlmacen, $IdCliente]);
