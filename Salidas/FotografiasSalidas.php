                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header text-white"
                                    ...
                                    <h1 class="card-title">FOTOGRAFIAS SALIDAS</h1>
                                </div>
                                <div class="card-body">
                                                ...
                                                <div class="col-12">
                                                    <form name="EnviarCorreo" id="EnviarCorreo" action="" method="POST"
                                                        ...
                                                        $sentFotografias = $Conexion->query("SELECT 
                                                            t2.IdTarja,
                                                            t3.NombreCliente,
                                                             FORMAT(t2.FechaSalida, 'dd/MM/yyyy') as FechaSalida,
                                                            t2.Almacen,
                                                            t5.NumRecinto
                                                        FROM t_Fotografias as t1 
                                                        INNER JOIN t_salida as t2 on t1.IdTarja=t2.IdTarja
                                                        ...
                                                        WHERE t1.Tipo=3 
                                                            ...
                                                            AND t2.FechaSalida = (
                                                                ...
                                                                FROM t_salida 
                                                                WHERE IdTarja = t2.IdTarja
                                                            )
                                                        GROUP BY t2.IdTarja,t2.FechaSalida,t3.NombreCliente,t2.Almacen,t5.NumRecinto");
                                                        ...
                                                        <td width="auto" style="text-align: center;">
                                                            <?php echo 'ALP' . $Fotos->NumRecinto . '-SAL-' . sprintf("%04d", $Fotos->IdTarja); ?>
                                                        </td>
                                                        <td width="auto" style="text-align: center;">
                                                            <?php echo $Fotos->NombreCliente; ?>
                                                        </td>
                                                        <td width="auto" style="text-align: center;">
                                                            <?php echo $Fotos->FechaSalida; ?>
                                                        </td>
                                                        <td width="auto" style="text-align: center;">
                    ...
                    <form id="formConfirmacionEnvio">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="tipoEnvio" id="soloSalida"
                                    value="soloSalida" checked>
                                <label class="form-check-label" for="soloSalida">
                                    Solo Tarja Salida
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="tipoEnvio" id="soloFotografica"
                                    value="soloFotografica">
...
<script type="text/javascript">
    ...
    function abrirModalFotos(idTarja, idAlmacen) {
        ...
        titulo.textContent = 'ALPSV-SAL-' + idTarja.toString().padStart(4, '0');
    ...
    function cargarFotosTarja(idTarja, idAlmacen) {
        $.ajax({
            ...
            error: function (xhr, status, error) {
                ...
                mostrarMensaje('error', 'Error al cargar las fotos. Por favor intente nuevamente.');
            }
        });
    }
