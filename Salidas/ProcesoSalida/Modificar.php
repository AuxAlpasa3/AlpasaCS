<div class="modal fade"  id="ModificarArticulo_<?php echo $Articulo->IdArticulo;?>" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header text-white" style="background-color: #d94f00;">
                <h5 class="modal-title text-white" id="title">Modificar Articulo</h5>
                <button class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form name="ModificarArticulo" id="ModificarArticulo"  method="POST" enctype="multipart/form-data">
                    <div class="row" style="align-content: center;">
                            <div class="col-md-1" style="text-align: center;">
                                <label for="Id">Id</label>
                                <div class="form-group">
                                    <input type="hidden" id="user" name="user" value="<?php echo $IdUsuario; ?>">
                                    <input id="IdArticulo" class="form-control" type="text" name="IdArticulo" value="<?php echo $Articulo->IdArticulo; ?>" disabled >
                                </div>
                            </div>
                            <div class="col-md-4" style="text-align: center;">
                                <label for="MaterialNo">Material No:</label>
                                <div class="form-group">
                                    <input id="MaterialNo" value="<?php echo $Articulo->MaterialNo;?>" class="form-control" type="number" name="MaterialNo" onKeyUp="this.value = this.value.toUpperCase();">
                                </div>
                            </div>
                            <div class="col-md-5" style="text-align: center;">
                                <label for="MaterialShape">Material/Shape:</label>
                                <div class="form-group">
                                    <input id="MaterialShape"  value="<?php echo $Articulo->MaterialShape;?>"  class="form-control" type="text" name="MaterialShape" onKeyUp="this.value = this.value.toUpperCase();">
                                </div>
                            </div>
                            <div class="col-md-2" style="text-align: center;">
                                  <label for="Piezas">Piezas</label>
                                  <div class="form-group">
                                    <input type="number" id="Piezas" value="<?php echo $Articulo->Piezas;?>"  class="form-control" name="Piezas" onKeyUp="this.value = this.value.toUpperCase();"/>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <select class="form-control" name="TMaterial" id="TMaterial">
                                            ...
                                            <option value="<?php echo $material->IdTipoMaterial;?>" 
                                                <?php if($Articulo->TipoMaterial==$material->IdTipoMaterial) 
                                                echo 'selected="selected"'; ?>>  
                                                <?php echo $material->TipoMaterial;?> 
                                            </option>
                                                <?php } ?>
                                        </select>
                                </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <select class="form-control" name="TEmbalaje" id="TEmbalaje">
                                          ...
                                          <option value="<?php echo $embalaje->IdTipoEmbalaje; ?>"
                                            <?php if($Articulo->TipoEmbalaje==$embalaje->IdTipoEmbalaje) echo 'selected'; ?>>  
                            ...
                            <div class="col-md-6" style="text-align: center;">
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="col-md-12" style="text-align: center;">
                                        <div class="form-group">
                                            <button class="btn btn-success" type="submit" name="Mov" value="ModiificarArticulo" id="Mov">Modificar</button>
