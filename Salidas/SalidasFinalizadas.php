            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header text-white" style="padding: 1rem; border-bottom: 2px solid #d94f00; background-color: #d94f00 ">
                  <h1 class="card-title">SALIDAS FINALIZADAS</h1>
                </div>
                <div class="card-body">
                  ...
                  <?php 
                    ...
                    $sql="SELECT t1.IdTarja AS IdTarja, t1.CodBarras AS CodBarras, CONVERT(DATE,t1.FechaSalida) as FechaSalida, t1.FechaProduccion,t1.IdArticulo,t2.MaterialNo, trim(Concat(t2.Material,t2.Shape)) as MaterialShape, t1.Piezas,t1.NumPedido,t1.NetWeight,t1.GrossWeight,t1.Cliente,t4.NombreCliente,t1.IdRemision,t1.IdLinea,t1.NoTarima  
                          FROM t_salida as t1 
                              ...
                              <table class="table table-bordered  table-striped" id="salidaTable" > 
                                <thead>
                                  <tr>
                                   ...
                                   <th width="auto" style="color:black; text-align: center;">NoTarima</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  <?php
