...
?>
<div class="modal fade" id="modificarDepto_<?php echo $ID; ?>_<?php echo $usuario; ?>" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header text-white" style="background-color: #808080;">
              ...
              <div class="modal-body">
                      <form name="editar" id="editar" action="mod_Departamento/procesos.php" method="POST">
                        <div class="row">
                          <div class="col-md-6">
                        ...
                        <div class="row">
                              <div class="col-md-12">
                                <div class="form-group">
                                      ...
                                      <input id="nombre" class="form-control" type="text" name="nombre" required placeholder="Nombre de la Depto" value="<?php echo  $Depto;?>">
                                </div>
                              </div>
                        </div> 
