...
<div class="modal fade"  id="nuevaEmpresa" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="nuevo" id="nuevo" action="mod_Empresa/procesos.php" method="POST">
        <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input id="Nombre" class="form-control" type="text" name="Nombre" required placeholder="Nombre de la Empresa">
                    </div>
                </div>
